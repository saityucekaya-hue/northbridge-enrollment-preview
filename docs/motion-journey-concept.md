...
| Celebration | View an animated milestone card | Choose pending enrollment tasks or campus opportunities and events; share or download a public PNG in Story or Post format |

The share image contains no legal name, student ID number, uploaded ID, face photo, or claim that enrollment is complete. Mobile platforms with a file-capable share sheet can receive the PNG; other browsers download it for the student to post in their chosen app.
